...
const MetadataItem: React.FC<MetadataItemProps> = ({ icon, text, className }) => (
...
export interface ArticleHeaderProps extends VariantProps<typeof articleHeaderVariants> {
  title: string;
  date: string;
  energyLevel: string;
  rating: number;
